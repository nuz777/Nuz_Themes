  ...
  private buildTracks(): Track[] {
    return [
      ...
      },
      {
        ...
        album: 'Gold',
        cover: '/caratulas/' + encodeURIComponent('GoldSpandau Ballet .png'),
      ...
      },
      {
        ...
        artist: 'Tame Impala',
        album: 'Currents',
        cover: '/caratulas/' + encodeURIComponent('TameImpala - TheLessIKnowTheBetter.png'),
      ...
      },
      {
        ...
        cover: '/caratulas/' + encodeURIComponent('Snow Strippers - Passionate highs.png'),
      ...
      },
      {
        ...
        artist: 'Tiishe',
        album: 'Tiishe',
        cover: '/caratulas/' + encodeURIComponent('StuckNextToYo -Tiishe.png'),
      ...
      },
      {
        ...
        cover: '/caratulas/kurxedEzxmelards.png',
      ...
      },
      {
        ...
        artist: 'Nuz',
        album: 'Nuz',
        cover: '/caratulas/AUTOMOTIVOANTI-CELESTIAL .png',
      ...
      },
      {
        ...
        cover: '/caratulas/takemetoyourheart.png',
      ...
      },
      {
        ...
        artist: 'Nuz',
        album: 'Nuz',
        cover: '/caratulas/TokyoReggie.png',
      ...
      },
      {
        ...
        cover: '/caratulas/russiandriver.png',
      ...
      },
      {
        ...
        artist: 'Nuz',
        album: 'Nuz',
        cover: '/caratulas/' + encodeURIComponent('𝐁𝐫𝐨𝐨𝐤𝐥𝐲𝐧𝐁𝐥𝐨𝐨𝐝𝐏𝐨𝐩𝐗𝐕𝐚𝐜𝐚𝐭𝐢𝐨𝐧𝐁𝐢𝐛𝐥𝐞𝐒𝐜𝐡𝐨𝐨𝐥.png'),
